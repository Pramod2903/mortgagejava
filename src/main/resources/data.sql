insert into offer values (1, 1000000 ,9, 10, 12668) ON DUPLICATE KEY UPDATE id=1;
insert into offer values (2, 1500000 ,9, 15, 15214) ON DUPLICATE KEY UPDATE id=2;
insert into offer values (3, 2000000 ,9, 15, 20285) ON DUPLICATE KEY UPDATE id=3;
